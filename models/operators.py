...
from mynn import Upsample, Norm2d
...
class PSPModule(nn.Module):
    ...
    # def __init__(self, features, out_features=512, sizes=(1, 2, 4, 8), norm_layer=nn.BatchNorm2d):
        super(PSPModule, self).__init__()

        print("features+len(sizes)*out_features=",features+len(sizes)*out_features)
        self.stages = []
    ...
    def forward(self, feats):
        ...
        # print("feats.size=",feats.size(0),feats.size(1),feats.size(2),feats.size(3))
        # print("feats=",feats)
        # print("self.stages=",self.stages)
        # for stage in self.stages:
        #     print("stage(feats), size=(h, w)=",stage(feats))
        #     print("stage(feats), size=(h, w)=",stage(feats), (h, w))
...
class AlignedModule(nn.Module):
    ...
    def __init__(self, inplane, outplane, kernel_size=3):
        ...
        self.flow_make = nn.Conv2d(outplane*2, 2, kernel_size=
